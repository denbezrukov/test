...
import styles from './textEllipsisOld.module.css';

interface TextEllipsisOldProps {
    children: string;
    tailLength: number;
    title?: string;
    className?: string;
...
interface TextEllipsisOldState {
    containerSize: NodeSize;
    ellipsisSize: NodeSize;
    staticSize: NodeSize;
}

const initialState: TextEllipsisOldState = {
    containerSize: initialNodeSize,
    ellipsisSize: initialNodeSize,
    staticSize: initialNodeSize,
};

const TextEllipsisOldComponent: FC<TextEllipsisOldProps> = props => {
...
export const TextEllipsisOld = memo(TextEllipsisOldComponent);
